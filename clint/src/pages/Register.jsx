...
const Register = () => {
  ...
  return (
    <div className="w-full flex justify-center items-center h-[80vh] ">
        ...
        <input value={username} onChange={(e)=>setUsername(e.target.value)} className="w-full px-4 py-2 border-2 border-black outline-0" type="text" placeholder="Enter your username" />
